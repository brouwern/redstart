...
```{r echo=FALSE}
# R references to "full annual cycle" (FAC) in titles / abstracts; in 2015 2 major papers #were published: @PeterPMarra et al A call for FAC research in animal #ecology #https://bit.ly/2KhqKag
#  
# 
