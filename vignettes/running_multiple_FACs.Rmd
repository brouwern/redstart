...
```{r}
F28.4.FAC.RM <- runFAC_multi(param.grid = F28.4.grid,
                          verbose = F, eq.tol = 2,
                          use.IBM = F,
                          run.IBM = F)

plot_Fig28_4(F28.4.FAC.RM)
```
...
plot_Fig28_4_IBM(runFAC.multi = F28.4.FAC, plot.debug.lines = T)
```
