...
#'
#' @details
#' This function compares total number of females (W2["fg"] + W2["fp"])
#' against K.bc, the  carrying capacity ("K.") of the breeding-ground
#' (".b.") source habiat (".c")
#'
#' Notes:
#' 1)If W2["fg"] + W2["fp"] < K.bc, then ALL birds went to the sour.c.e
#' (via the previous function) and 0 birds end up going to the breeding sink
#'
#' 2)If K.bc < W2["fg"] + W2["fp"], then the total female pop is larger
