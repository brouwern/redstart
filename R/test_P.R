...
#'
#' @param dat dataframe with values against which to test function.  An object named test_dat_P is available for testing.
...
#' @param sample.N how many subsamples of dataframe to take
